...
const MuiDataGrid: Components<Theme>['MuiDataGrid'] = {
  ...
  styleOverrides: {
    root: ({ theme }) => {
      const rowsAreaBackground = theme.vars.palette.background.default;
      const baseStyles: CSSObject = {
        borderWidth: 0,
        backgroundColor: 'transparent',
        '& .MuiDataGrid-scrollbar': {
          backgroundColor: rowsAreaBackground,
        },
      };
      const pinnedActionsOffset = 'calc(var(--DataGrid-hasScrollY) * var(--DataGrid-scrollbarSize))';
      const pinnedActionsBorder = `1px solid ${varAlpha(theme.vars.palette.grey['500Channel'], 0.24)}`;
      const pinnedActionsStyles: CSSObject = {
        [`& .${gridClasses.columnHeader}[data-field="actions"]`]: {
          position: 'sticky',
          right: pinnedActionsOffset,
          zIndex: 41,
          backgroundColor: theme.vars.palette.background.neutral,
          borderLeft: pinnedActionsBorder,
        },
