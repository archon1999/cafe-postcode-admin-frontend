...
const resources = [
  { common: uzCommon, messages: uzMessages, users: uzUsers },
  { common: uzCyrlCommon, messages: uzCyrlMessages, users: uzCyrlUsers },
  { common: ruCommon, messages: ruMessages, users: ruUsers },
] as const;
