...
import { FileThumbnail } from 'shared/ui/FileThumbnail';
...
export function NotificationItem({ notification }: NotificationItemProps) {
  ...
  const { t: tMessages } = useTranslate('messages');
  ...
  const renderProjectAction = () => (
    <>
      <Box
        ...
        {readerContent(tMessages('notifications.project.feedback'))}
      </Box>
  ...
  const renderTagsAction = () => (
    <Box
      ...
      <Label variant="outlined" color="info">
        {tMessages('notifications.tags.design')}
      </Label>
      <Label variant="outlined" color="warning">
        {tMessages('notifications.tags.dashboard')}
      </Label>
      <Label variant="outlined">{tMessages('notifications.tags.designSystem')}</Label>
    </Box>
  );
