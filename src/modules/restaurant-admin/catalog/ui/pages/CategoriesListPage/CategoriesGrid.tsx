...
export function CategoriesGrid() {
  ...
  const { filters, setFilters, paginationModel, setPaginationModel, columnVisibilityModel, setColumnVisibilityModel } =
    useDataGridPreferences<CategoriesGridFilters>('catalog-categories', {
      filters: DEFAULT_CATEGORIES_GRID_FILTERS,
  ...
  const baseColumns = useMemo<GridColDef<CatalogCategory>[]>(
    () => [
