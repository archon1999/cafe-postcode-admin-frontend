...
export function KitchenTicketsGrid() {
  ...
  const [filters, setFilters] = useState<KitchenTicketsGridFilters>(DEFAULT_KITCHEN_TICKETS_GRID_FILTERS);
  ...
  const handleFiltersChange = useCallback((next: KitchenTicketsGridFilters) => {
    setFilters(next);
