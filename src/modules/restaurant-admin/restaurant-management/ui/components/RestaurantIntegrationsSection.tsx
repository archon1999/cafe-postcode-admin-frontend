...
export function RestaurantIntegrationsSection({
  ...
  } = useDataGridPreferences('restaurant-integrations', {
  ...
  const baseColumns = useMemo<GridColDef<AdminIntegrationConfig>[]>(() => {
    const columns: GridColDef<AdminIntegrationConfig>[] = [
      {
        field: 'kind',
