...
import { BranchCashDesksSection } from './BranchCashDesksSection';
import { BranchDevicesSection } from './BranchDevicesSection';
import { BranchDistributionPointsSection } from './BranchDistributionPointsSection';
import { BranchPrepStationsSection } from './BranchPrepStationsSection';
        ...
        <Stack spacing={2}>
          ...
          {showIntegrationsManagement ? (
            <>
              ...
              />
              <BranchDistributionPointsSection
