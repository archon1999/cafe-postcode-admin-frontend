  ...
  return (
    <>
      <BranchManagementAccordion
        ...
        description={description ?? t('branchManagement.sections.prepStations.description')}
                  ...
                  filters={[
                    {
                      ...
                      testId: 'branch-prepstations-kind-filter',
                    ...
                    },
                    {
                      ...
                      testId: 'branch-prepstations-status-filter',
                      emptyLabel: t('filters.all'),
                    },
                  ]}
                  columns={columns}
